async function SparkPhysics(moduleArg = {}) {
    var moduleRtn;
    ...
    function initRuntime() { runtimeInitialized = true; wasmExports["E"](); }
    ...
    async function instantiateAsync(binary, binaryFile, imports) { if (!binary && !ENVIRONMENT_IS_NODE) {
        try {
    ...
    var _malloc, _free, ___getTypeName, memory, __indirect_function_table, wasmMemory, wasmTable;
    function assignWasmExports(wasmExports) { _malloc = wasmExports["G"]; _free = wasmExports["H"]; ___getTypeName = wasmExports["I"]; memory = wasmMemory = wasmExports["D"]; __indirect_function_table = wasmTable = wasmExports["F"]; }
    var wasmImports = { u: ___cxa_throw, w: __abort_js, t: __embind_register_bigint, B: __embind_register_bool, l: __embind_register_class, r: __embind_register_class_constructor, b: __embind_register_class_function, v: __embind_register_constant, z: __embind_register_emval, s: __embind_register_float, m: __embind_register_integer, k: __embind_register_memory_view, A: __embind_register_std_string, o: __embind_register_std_wstring, C: __embind_register_void, f: __emval_create_invoker, a: __emval_decref, d: __emval_get_property, j: __emval_incref, h: __emval_invoke, n: __emval_new_array, c: __emval_new_cstring, e: __emval_new_object, g: __emval_run_destructors, i: __emval_set_property, y: _clock_time_get, p: _emscripten_get_now, x: _emscripten_resize_heap, q: _fd_write };
...
//# sourceMappingURL=spark.mjs.map